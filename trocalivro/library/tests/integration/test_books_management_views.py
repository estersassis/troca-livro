...
def test_book_add_post_creates_book_successfully(client, user_factory, profile_factory):
    ...
    client.force_login(user)
    response = client.post(reverse('book-add'), {
...
@pytest.mark.django_db
def test_book_add_post_with_invalid_data_redirects(client, user_factory, profile_factory):
...
@pytest.mark.django_db
def test_search_book_empty_query_returns_empty_list(client, book_factory, profile_factory):
...
@pytest.mark.django_db
def test_search_book_whitespace_query_returns_empty_list(client, book_factory, profile_factory):
...
@pytest.mark.django_db
def test_search_book_combines_title_and_author_results(client, book_factory, profile_factory):
...
@pytest.mark.django_db
def test_book_add_redirects_to_book_detail_on_success(client, user_factory, profile_factory):
