...
def test_request_exchange_view_success(client, user_factory, book_factory, profile_factory):
    user = user_factory()
...
@pytest.mark.django_db
def test_request_exchange_view_cannot_request_own_book(client, user_factory, book_factory, profile_factory):
    user = user_factory()
    profile = profile_factory(user=user)
...
@pytest.mark.django_db
def test_request_exchange_view_cannot_request_unavailable_book(client, user_factory, book_factory, profile_factory):
    user = user_factory()
    profile = profile_factory(user=user)
...
@pytest.mark.django_db
def test_request_exchange_view_duplicate_request_not_allowed(client, user_factory, book_factory, profile_factory):
    user = user_factory()
    profile = profile_factory(user=user)
...
@pytest.mark.django_db
def test_request_exchange_view_request_nonexistent_book(client, user_factory, profile_factory):
    user = user_factory()
    profile = profile_factory(user=user)
